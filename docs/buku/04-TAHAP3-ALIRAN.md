...
Tenaga mesin berbanding lurus dengan **massa udara** yang bisa masuk dan terbakar. Semua komponen lain — cam, pengapian, knalpot, CVT — cuma menentukan seberapa dekat kamu ke plafon yang sudah ditetapkan head.
...
**Konsekuensinya:** kalau head-mu mengalirkan 85 CFM, tidak ada cam, knalpot, atau ECU yang bisa membuatnya menghasilkan 50 HP. Plafonnya sekitar 38 HP, titik.

---

## 2. Klep dan batas geometri

### 2.1 Berapa besar klep yang muat
...
Bukan diameter klep, tapi **luas klep isap dibagi luas bore**:

```
rasio = n_klep × (D_klep / bore)²
```

| Rasio | Keterangan |
|---|---|
| 0,24 | 2 klep bore kecil — terbatas |
| 0,26 | 3 klep |
| 0,297 | 2 klep bore besar, ATAU 4 klep bore kecil |
| 0,30–0,35 | 4 klep bagus |

**Ini plafon geometri.** Tidak bisa dilampaui tanpa mengganti head atau bore.

### 2.3 Rasio klep buang terhadap isap
...
Tapi yang lebih menentukan keputusan cam bukan rasio klep, melainkan **rasio throat** — dibahas di 3.4.

---

## 3. Throat: pembatas yang sesungguhnya

### 3.1 Kenapa throat, bukan klep
...
Mesin Contoh B, klep isap 22 mm, throat awal 19,5 mm (rasio 0,886).

Rasio 0,935 yang terbukti di Mesin Contoh A memberi throat 20,6 mm — tapi lebar seat tinggal 0,71 mm, terlalu tipis untuk klep sekecil itu.
...
| Luas throat (2 klep) | 597 mm² | 641 mm² |
| Gain | — | **+7,4%** |
| CFM @28" | 84,5 | 90,7 |
| Potensi HP | 38,0 | ~41 |
...
**Throat buang jangan digerus sebesar throat isap.** Seat buang butuh lebar untuk membuang panas klep. Rasio throat/klep sisi buang yang lazim: **0,86–0,90**, lebih konservatif daripada sisi isap.
...
|---|---|---|---|
| Contoh A (2 klep) | 6,78 mm | 10,8 mm | 1,59× |
| Contoh B (4 klep) | 4,64 mm | 9,0 mm | 1,94× |
| Contoh C (3 klep) | 4,59 mm | — | — |
...
Ini koreksi penting terhadap aturan umum "lift maksimum berguna = 0,25 × diameter klep". Aturan itu benar untuk flow puncak, salah untuk mesin balap.
...
Pada 3 klep, klep buang tunggal butuh **lift lebih tinggi** daripada klep isap. Satu klep besar punya keliling total lebih kecil daripada dua klep kecil berluas sama, jadi butuh lift lebih tinggi untuk membuka tirai yang sama.

**Praktisnya untuk 3 klep:** lift ex sekitar 15% lebih tinggi dari lift in.
**Praktisnya untuk 4 klep:** lift ex bisa 10–15% lebih rendah dari lift in tanpa rugi flow — menghemat beban valvetrain.
...
|---|---|---|
| > 1,0 | port lebih besar dari throat | aliran **mempercepat** menuju throat — stabil, menempel |
| < 1,0 | port lebih kecil dari throat | titik sempit pindah ke port; ada **pelebaran** sebelum klep — cenderung lepas |
...
Untuk port 4 klep bercabang, penampang **tinggi-sempit** (aspect tinggi:lebar sekitar 1,3) secara teori lebih baik daripada bundar. Port yang tinggi membuat short-turn radius lebih landai relatif terhadap tinggi port, sehingga aliran tidak mudah lepas di lantai.
...
Bentuk mulut port di bidang flange berpengaruh besar — sering lebih besar dari rugi tikungan seluruh port.
...
2. **Luas klep isap / luas bore** adalah plafon geometri. 0,24 untuk 2 klep bore kecil, 0,30+ untuk 4 klep.
...
6. **Rasio port/throat sebaiknya > 1,0** — port sedikit lebih besar dari throat.
